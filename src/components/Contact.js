              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-text-secondary">tsegayes332@gmail.com</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-text-secondary">+251 940 680 260</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-text-secondary">Addis Ababa, Ethiopia</div>
                  </div>
                </div>
              </div>
