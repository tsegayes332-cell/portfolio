        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 relative mt-6 lg:mt-0">
            ...
            >
              {/* Window Titlebar */}
              <div
                className="flex items-center justify-between px-4 py-3 border-b border-slate-800 bg-[#1E293B]"
              >
                {/* Window Controls */}
                ...
                <div className="flex items-center gap-1 text-xs">
                  <button
                    ...
                    className={`px-3 py-1 rounded-md transition-all font-mono flex items-center gap-1.5 ${
                      activeTab === 'developer.ts'
                        ? 'bg-[#0B0F19] text-blue-400 font-semibold'
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-md transition-all font-mono flex items-center gap-1.5 ${
                      activeTab === 'stats.sh'
                        ? 'bg-[#0B0F19] text-emerald-400 font-semibold'
                        : 'text-slate-400 hover:text-slate-200'
                    }`}
                  >
              ...
              {/* Bottom bar */}
              <div
                className="px-4 py-2 text-[11px] font-mono flex items-center justify-between border-t border-slate-800 bg-[#0B0F19] text-slate-400"
              >
                <span>UTF-8</span>
