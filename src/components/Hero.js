...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center bg-white pt-20 relative">
      <div className="container-custom w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="w-12 h-1 bg-primary rounded-full mx-auto lg:mx-0 mb-8"></div>
          ...
          <div className="hidden lg:block">
            <div className="bg-dark rounded-2xl border border-light-gray p-8">
              <h3 className="text-sm font-semibold text-text-primary uppercase tracking-wider border-b border-light-gray pb-3 mb-6">
                Profile
              </h3>
              <dl className="space-y-4">
                <div className="flex justify-between gap-4">
                  <dt className="text-text-secondary text-sm">Location</dt>
                  <dd className="text-text-primary text-sm font-medium text-right">Addis Ababa, Ethiopia</dd>
                </div>
                <div className="flex justify-between gap-4">
                  <dt className="text-text-secondary text-sm">Education</dt>
                  <dd className="text-text-primary text-sm font-medium text-right">B.Sc. Computer Science</dd>
                </div>
                <div className="flex justify-between gap-4">
                  <dt className="text-text-secondary text-sm">Focus</dt>
                  <dd className="text-text-primary text-sm font-medium text-right">Web &amp; Mobile</dd>
                </div>
                <div className="flex justify-between gap-4">
                  <dt className="text-text-secondary text-sm">Stack</dt>
                  <dd className="text-text-primary text-sm font-medium text-right">React, React Native, PHP</dd>
                </div>
                <div className="flex justify-between gap-4">
                  <dt className="text-text-secondary text-sm">Status</dt>
                  <dd className="text-primary text-sm font-medium text-right">Open to Work</dd>
                </div>
              </dl>
            </div>
          </div>
